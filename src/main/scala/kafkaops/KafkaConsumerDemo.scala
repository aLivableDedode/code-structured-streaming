...
object KafkaConsumerDemo {
  def main(args: Array[String]): Unit = {
    ...
    prop.put("bootstrap.servers", "10.17.255.39:9092,10.17.255.15:9092,10.17.255.88:9092")
    // 指定消费者组
    ...
    // 首先需要订阅topic
    kafkaConsumer.subscribe(Collections.singletonList("ndc_gid_doc_sync"))
    // 开始消费数据
    while (true) {
...
//       println(s"========> mgs.count:${msgs.count()}")
